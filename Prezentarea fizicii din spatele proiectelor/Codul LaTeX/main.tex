...
\node[anchor=center, 
      ...
      yshift=1cm] 
     at (current page.center) 
     {\includegraphics[scale=0.13]{Imagini/vertexuri.png}};
\end{tikzpicture}
...
\begin{itemize}
     ...
     \item[\ding{37}] \makebox[0.5cm]{} \textit {\textbf{ Simularea grafică a jetului de particule care rezultă din interacțiunea unui proton cu Ec = 100 GeV și 10 straturi de atmosferă. Multiple ramificații sunt alocate unor radiații gamma rezultate din dezintegrarea pionilor(tracks-urile verzi).}}
...
\node[anchor=center, 
      ...
      yshift=0.5cm] 
     at (current page.center) 
     {\includegraphics[scale=0.4]{Imagini/Shower.png}};
\end{tikzpicture}
...
\node[anchor=center, 
      ...
      yshift=1cm] 
     at (current page.center) 
     {\includegraphics[scale=0.2]{Imagini/JET.png}};
\end{tikzpicture}
...
\begin{itemize}
     ...
     \item[\ding{39}] \makebox[0.5cm]{} \textit {\textbf{ Ramificațiile ilustrează producerea în lanț a multor fluxuri secundare de particule(multiple vertexuri), majoritatea orientate în aceeași direcție cu particula primară.}}
...
%distrib fotoni
\begin{frame}{\textbf{Distribuția pe OX a fotonilor receptați - Monte Carlo}}
...
\node[anchor=center, 
      ...
      yshift=0cm] 
     at (current page.center) 
     {\includegraphics[scale=0.21]{Imagini/Ox foton.png}};
\end{tikzpicture} 

\end{frame}


\begin{frame}{\textbf{Distribuția pe OY a fotonilor receptați - Monte Carlo}}
\begin{tikzpicture}[overlay, remember picture]
\node[anchor=center, 
      xshift=0cm, 
      yshift=0cm] 
     at (current page.center) 
     {\includegraphics[scale=0.21]{Imagini/Oy foton.png}};
\end{tikzpicture} 
...
\node[anchor=center, 
      ...
      yshift=-0.5cm] 
     at (current page.center) 
     {\includegraphics[scale=0.2]{Imagini/QE.png}};
\end{tikzpicture} 
